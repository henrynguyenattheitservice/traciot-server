# [TracIoT](https://theitservice.com.au:3000)

Configure traccar or traciot to work with IntelliJ IDEA.
Change the logo to traciot and configure IntelliJ IDEA for debugging.
...
![TracIoTInActionMap.png](TracIoTInActionMap.png)
